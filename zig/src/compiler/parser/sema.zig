...
pub fn analyze(allocator: Allocator, program: ast.ProgramNode, src: []const u8, file_path: []const u8) !void {
    ...
    {
        var struct_it = program.struct_defs.iterator();
